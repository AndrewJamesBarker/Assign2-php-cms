...
<table>
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    <tr>
      ...
      <td align="center"><?php echo $record['sighting_id']; ?></td>
      <td align="left">
      ...
      <td align="center"><a href="sightings_photo.php?id=<?php echo $record['photo']; ?>"><i class="fa-solid fa-image"></i></a><br><br><a href="sightings_edit.php?id=<?php echo $record['sighting_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a><br><br>
        <a href="sightings.php?delete=<?php echo $record['sighting_id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this project?');"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
  <?php endwhile; ?>
</table>
