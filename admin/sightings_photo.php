...
<p>
  Note: For best results, photos should be approximately 400 x 300 pixels.
</p>
...
<?php if( $record['photo'] ): ?>
  ...
  <p><a href="sightings_photo.php?id=<?php echo $_GET['sighting_id']; ?>&delete"><i class="fas fa-trash-alt"></i> Delete this Photo</a></p>
